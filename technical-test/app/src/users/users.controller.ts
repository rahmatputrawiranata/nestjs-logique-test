import { Body, Controller, Get, HttpException, Param, ParseFilePipeBuilder, Patch, Post, UploadedFile, UploadedFiles, UseInterceptors } from '@nestjs/common';
...
export class UsersController {
    ...
    async register(@UploadedFiles(
        ...
        const missingFields = requiredFields.filter(field => !validatorData[field]);
